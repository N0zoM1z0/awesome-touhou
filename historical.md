...
- [Touhou Music Database](https://github.com/solaasan/Touhou-Music-Database) - An older reverse-search SQLite dataset for Touhou arrangements, retained for its normalized schema and research value; its maintainer warns that the data may be out of date.
